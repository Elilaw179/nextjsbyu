  ...
  return (
    <form action={formAction}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6 space-y-4">
        ...
        <div>
          ...
          <div className="flex gap-4">
            <label className="flex items-center gap-1">
              <input type="radio" name="status" value="pending" defaultChecked={invoice.status === 'pending'} />
              Pending
            </label>
            <label className="flex items-center gap-1">
              <input type="radio" name="status" value="paid" defaultChecked={invoice.status === 'paid'} />
              Paid
            </label>
          </div>
        ...
        <button type="submit" className="rounded-md bg-blue-500 px-4 py-2 text-sm text-white hover:bg-blue-400">
          Update Invoice
        </button>
      </div>
    </form>
